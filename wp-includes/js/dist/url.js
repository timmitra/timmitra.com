  ...
  !(function () {
    ...
    __webpack_require__.d(__webpack_exports__, {
      ...
      filterURLForDisplay: function () {
        return /* reexport */ filterURLForDisplay;
      },
      getAuthority: function () {
        return /* reexport */ getAuthority;
      },
      getFilename: function () {
        return /* reexport */ getFilename;
      },
      getFragment: function () {
        return /* reexport */ getFragment;
      },
      getPath: function () {
        return /* reexport */ getPath;
      },
      getPathAndQueryString: function () {
        return /* reexport */ getPathAndQueryString;
      },
      getProtocol: function () {
        return /* reexport */ getProtocol;
      },
      getQueryArg: function () {
        return /* reexport */ getQueryArg;
      },
      getQueryArgs: function () {
        return /* reexport */ getQueryArgs;
      },
      getQueryString: function () {
        return /* reexport */ getQueryString;
      },
      hasQueryArg: function () {
        return /* reexport */ hasQueryArg;
      },
      isEmail: function () {
        return /* reexport */ isEmail;
      },
      isURL: function () {
        return /* reexport */ isURL;
      },
      isValidAuthority: function () {
        return /* reexport */ isValidAuthority;
      },
      isValidFragment: function () {
        return /* reexport */ isValidFragment;
      },
      isValidPath: function () {
        return /* reexport */ isValidPath;
      },
      isValidProtocol: function () {
        return /* reexport */ isValidProtocol;
      },
      isValidQueryString: function () {
        return /* reexport */ isValidQueryString;
      },
      normalizePath: function () {
        return /* reexport */ normalizePath;
      },
      prependHTTP: function () {
        return /* reexport */ prependHTTP;
      },
      removeQueryArgs: function () {
        return /* reexport */ removeQueryArgs;
      },
      safeDecodeURI: function () {
        return /* reexport */ safeDecodeURI;
      },
      safeDecodeURIComponent: function () {
        return /* reexport */ safeDecodeURIComponent;
      },
     ...
     * const authority2 = getAuthority( 'https://www.timmitra.com:8080/test/' ); // 'localhost:8080'
     * ```
     *
     ...
     * @example
     * ```js
     * const path1 = getPath( 'https://www.timmitra.com:8080/this/is/a/test?query=true' ); // 'this/is/a/test'
     ...
     * @example
     * ```js
     * const queryString = getQueryString( 'https://www.timmitra.com:8080/this/is/a/test?query=true#fragment' ); // 'query=true'
     * ```
     *
     ...
     * @example
     * ```js
     * const pathAndQueryString1 = getPathAndQueryString( 'https://www.timmitra.com:8080/this/is/a/test?query=true' ); // '/this/is/a/test?query=true'
     ...
     * @example
     * ```js
     * const fragment1 = getFragment( 'https://www.timmitra.com:8080/this/is/a/test?query=true#fragment' ); // '#fragment'
    ...
    function setPath(object, path, value) {
      ...
      for (let i = 0; i < length; i++) {
        ...
        key = ["__proto__", "constructor", "prototype"].includes(key)
          ? key.toUpperCase()
          : key; // If the next key in the path is numeric (or empty string), it will be
    ...
    var remove_accents_default =
      /*#__PURE__*/ __webpack_require__.n(remove_accents); // CONCATENATED MODULE: ./node_modules/@wordpress/url/build-module/clean-for-slug.js
    /**
     ...
     * @example
     * ```js
     * const filename1 = getFilename( 'https://www.timmitra.com:8080/this/is/a/test.jpg' ); // 'test.jpg'
